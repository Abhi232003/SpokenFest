...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url()?>front/images/favicon_io/favicon-32x32.png">
  <!-- Start css -->
    ...
    <div id="containerbar">
        ...
        <div class="leftbar">
            ...
            <div class="sidebar">
                <!-- Start Logobar -->
                <div class="logobar">
                    <a href="<?php echo base_url('index');?>" class="logo logo-large"><img src="<?= base_url($this->general_settings['favicon']); ?>" class="img-fluid" alt="logo"></a>
                    <a href="<?php echo base_url('index');?>" class="logo logo-small"><img src="<?= base_url($this->general_settings['favicon']); ?>" class="img-fluid" alt="logo"></a>
                </div>
                <!-- End Logobar -->
                <!-- Start Navigationbar -->
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="mobile-logobar">
                            <a href="<?php echo base_url('index');?>" class="mobile-logo"><img src="<?= base_url($this->general_settings['favicon']); ?>" class="img-fluid" alt="logo"></a>
                        </div>
