...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <!-- <a href="<?= base_url('admin/partner/add_edit'); ?>"><button class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add New Partner</button></a>
                 <a href="<?=base_url();?>admin/partner/importExcel" class="btn btn-warning"><i class="feather icon-edit mr-2"></i>Import Excel</a> -->
            </div>                        
        </div>
    </div>          
</div>
        ...
        <div class="col-lg-12">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <button type="submit" class="mt-2 btn-md btn btn-success-rgba" style="margin-top:29px !important ;">Export To Excel</button>
                   </div>
               </div>
           </div>
                <?php echo form_close(); ?>
...
<script>
  ...
  $(document).ready(function(){
    ...
    { "targets": 4, "name": "dateAdded", 'searchable':true, 'orderable':true,'width':'100px'},
