                ...
                <div class="card-body">
                   <!-- For Messages -->
                    ...
                    <?php echo form_open_multipart(base_url('admin/lineup/add_edit'), 'class="form-horizontal"');  ?> 
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="sortOrder"><span class="text-danger">*</span> Lineup Sort Order</label>                        
                                <input type="text" autocomplete="off"  name="sortOrder" class="form-control" id="sortOrder" value="<?php echo isset($Fetch_data['sortOrder']) ? set_value("sortOrder", $Fetch_data['sortOrder']) : set_value("sortOrder"); ?>" placeholder="">
                            </div>
                        </div>
                        <div class="form-row">
