...
<script>
  ...
  var table = $('#na_datatable').DataTable({
    ...
    { "targets": 2, "name": "year", 'searchable':true, 'orderable':true,'width':'100px'},

    { "targets": 3, "name": "lineupThumbImage", 'searchable':true, 'orderable':true,'width':'100px'},

     { "targets": 4, "name": "lineupDetailsImage", 'searchable':true, 'orderable':true,'width':'100px'},
